 ...
 */
if ($_SERVER["HTTP_HOST"] != "localhost") $config['site_domain'] = '/mch_2011b/';
else $config['site_domain'] = 'localhost/pest/';
...
(
	...
	MODPATH.'mch_form',
	MODPATH.'mch_role',
    MODPATH.'mch_permissions',
	MODPATH.'update_version'
);
