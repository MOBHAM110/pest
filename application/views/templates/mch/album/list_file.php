...
<tr class="row<?php echo $i%2==0?2:''?>">
    ...
    <td align="center"><img src="<?php echo $file['file_path_html']?>" width="<?php echo !empty($arr['width'])?($arr['width'].'px'):'auto'?>" height="<?php echo !empty($arr['height'])?($arr['height'].'px'):@$maxh?>" />
    </td>
...
<tr><td colspan="2"><textarea name="des_<?php echo $file['bbs_file_id']?>" rows="2" cols="30"><?php echo $file['bbs_file_description']?></textarea></td>
<?php } ?>
</table>