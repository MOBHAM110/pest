<table class="banner" align="center" cellspacing="0" cellpadding="0">
<tr><td class="banner_top"></td></tr>
<?php foreach ($layout['list_right_T_banner'] as $banner) { ?>
<tr>
    <td class="banner_middle" valign="middle"><?php if ($banner['banner_type'] == 'image') { ?>
