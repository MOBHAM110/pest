...
<tr><td class="login_block_middle" valign="top">
    ...
    <tr><td class="login_content_btn" align="center"><button type="submit" class="button_login" style="height:21px; width:80px; border:none;"><?php echo Kohana::lang('login_lang.btn_login')?></button></td>
    </tr>
    <tr>
