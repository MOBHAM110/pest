...
<tr class="login_caption">
    <td class="login_caption"><?php echo Kohana::lang('login_lang.tt_admin_page')?></td>
</tr>
<tr>
...
<tr>
    <td class="login_footer"><?php echo $this->site['site_footer']?><br />MCH <?php echo $this->site['version']?></td>
</tr>
</table>
