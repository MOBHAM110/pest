...
<tr>
    ...
    <td width="63%">
    	<input name="txt_username" type="text" id="txt_username" style="width:12em;" class="username" value="<?php echo isset($mr['txt_username'])?$mr['txt_username']:''?>" autofocus required>
	</td>
</tr>
<tr>
