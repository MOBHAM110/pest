...
<div class="yui3-g form">
  <div class="yui3-g">
    ...
    <div class="yui3-u-4-5"><?php echo isset($mr['user_name'])?$mr['user_name']:''?></div>
  </div>
  <div class="yui3-g">
  ...
  <div class="yui3-g">
    ...
    <div class="yui3-u-4-5"><input tabindex="4" type="text" name="txt_email" id="txt_email" value="<?php echo isset($mr['user_email'])?$mr['user_email']:''?>" size="50" /></div>
  </div>
