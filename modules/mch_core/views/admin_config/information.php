...
<div class="yui3-g">
    <div class="yui3-u-1-6 right"><?php echo Kohana::lang('account_lang.lbl_contact_name')?>:</div>
    <div class="yui3-u-4-5"><input id="txt_contact" name="txt_contact" type="text" size="50" value="<?php echo $this->site['site_contact_name']?>"/></div>
</div>
<div class="yui3-g" style="background-color:#5C9CCC;color:#FFF;">
...
<div class="yui3-g">
    <div class="yui3-u-1-6 right">Facebook:</div>
    <div class="yui3-u-4-5"><input id="txt_facebook" name="txt_facebook" type="text" size="50" value="<?php echo $this->site['site_facebook']?>"/></div>
</div>
<div class="yui3-g">
    <div class="yui3-u-1-6 right">Twitter:</div>
    <div class="yui3-u-4-5"><input id="txt_twitter" name="txt_twitter" type="text" size="50" value="<?php echo $this->site['site_twitter']?>"/></div>
</div>
<div class="yui3-g">
    <div class="yui3-u-1-6 right">Youtube:</div>
    <div class="yui3-u-4-5"><input id="txt_youtube" name="txt_youtube" type="text" size="50" value="<?php echo $this->site['site_youtube']?>"/></div>
</div>
<div class="yui3-g">
    <div class="yui3-u-1-6 right">Linkedin:</div>
    <div class="yui3-u-4-5"><input id="txt_linkedin" name="txt_linkedin" type="text" size="50" value="<?php echo $this->site['site_linkedin']?>"/></div>
</div>