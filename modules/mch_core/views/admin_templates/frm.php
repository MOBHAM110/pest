...
<tr>
    ...
    <td>
    	<input name="txt_name" type="text" id="txt_name" value="<?php echo (isset($mr['templates_name']))?$mr['templates_name']:''?>" size="50"> 
    </td>
</tr>
<?php if (isset($mr['templates_dir'])) { ?>
<tr>
    <td><?php echo Kohana::lang('themes_templates_lang.lbl_dir')?></td>
    <td><font color="#FF0000"><b><?php echo $mr['templates_dir']?></b></font></td>
</tr>
<?php } // end if ?>
<tr>
...
<tr>
    ...
    <td>
    	<select name="sel_status">
            ...
            <option value="0" <?php echo (isset($mr['templates_status'])&&!$mr['templates_status'])?'selected="selected"':''?>>
...
<input name="hd_id" type="hidden" id="hd_id" value="<?php echo isset($mr['templates_id'])?$mr['templates_id']:''?>"/>
</form>
