<?php
class Form_Controller extends Template_Controller 
{
	public $template;	
    ...
    public function __call($method, $arguments)
	{
		...
		elseif ($method === 'pid') 
		{
			if (!isset($arguments[1])) $this->_show();
	...
	{		
		...
		$this->template->content = new View('templates/'.$this->site['config']['TEMPLATE'].'/form/'.$page['page_content']);
		
		if (empty($page)) $this->template->content = '';
