<?php
class Bbs_MPTT_Model extends ORM_MPTT 
{
	protected $table_name = 'bbs';
	protected $primary_key = 'bbs_id';
	protected $left_column = 'bbs_left';
	protected $right_column = 'bbs_right';
	protected $level_column = 'bbs_level';
