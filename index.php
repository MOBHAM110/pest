 ...
 */
version_compare(PHP_VERSION, '5.2', '<') and exit('This application requires PHP 5.2 or newer.');
...
if (file_exists(DOCROOT.'install/install'.EXT))
{
	// Load the installation tests
	include DOCROOT.'install/install'.EXT;
}
else
{
	// Initialize Kohana
